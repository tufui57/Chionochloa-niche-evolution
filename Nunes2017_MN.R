...
trials=5  #number of RTRs per batch, (e.g do 100 RTRs each time, to measure percentile, stability, duplicates etc) 
cutoff=79  # stop running when reaches this number+1
sample=2 #define how many percentiles necessary to measure stability
...
RTRs<-foreach(i=1:trials, .combine='cbind', .errorhandling='remove') %dorng% {
