...
source(".//Chionochloa niche evolution//scripts//LGM climate niche//00_PastDataPreparation.R")
...
# Save polygon of the largest island of Zealandia in the LGM
if(file.exists(".\\LGM_mainisland\\mainIsland.shp")){
  print("You have the polygon in .\\LGM_mainisland\\mainIsland.shp")
}else{
  mainland <- as(split.poly[max.area,], "SpatialPolygonsDataFrame")
  writeOGR(mainland, dsn = ".", layer = 'mainIsland', driver = "ESRI Shapefile")
}
...
save(lgm.mainland, file = ".//LGMclimate.data")
